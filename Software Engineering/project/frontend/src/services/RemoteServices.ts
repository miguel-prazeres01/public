...
export default class RemoteServices {
  ...
  static async getDifficultQuestion(dashboardId: number): Promise<DifficultQuestion[]> {
    return httpClient
      .get(`/students/dashboards/${dashboardId}/difficultQuestions/Get`)
      .then((response) => {
  ...
  static async removeDifficultQuestion(difficultQuestionId: number) {
    return httpClient
      .delete(`/students/dashboards/difficultQuestions/Remove/${difficultQuestionId}`)
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  }
  ...
  static async updateDifficultQuestions(dashboardId: number){
    return httpClient
      .put(
        `/students/dashboards/${dashboardId}/difficultQuestions/Update`
      ).catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  ...
  static async getFailedAnswers(dashboardId: number): Promise<FailedAnswer[]> {
      return httpClient
        .get(`/students/dashboards/${dashboardId}`)
        .then((response) => {
  ...
  static async getWeeklyScores(dashboardId: number): Promise<WeeklyScore[]> {
    return httpClient
        .get(`/students/dashboards/${dashboardId}/weeklyScores/Get`)
        .then((response) => {
  ...
  static async updateWeeklyScores(dashboardId: number){
    return httpClient
        .put(`/students/dashboards/${dashboardId}/weeklyScores/Update`)
        .catch(async (error) => {
          throw Error(await this.errorMessage(error));
        });
  }
  ...
  static async deleteWeeklyScore(weeklyScoreId: number) {
    return httpClient
        .delete(`/students/dashboards/weeklyScores/${weeklyScoreId}/Remove`)
        .catch(async (error) => {
          throw Error(await this.errorMessage(error));
        });
  }
